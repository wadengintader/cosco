  ...
  return (
    <>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden opacity-15">
          <Image
            src="https://i.imgur.com/xQLbd9q.png"
            alt=""
            width={100}
            height={100}
          ...
          />
          <Image
            src="https://i.imgur.com/sfDimnA.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/Ja1ihFH.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/zFzm4wc.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/cU4cAlH.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/6Oog0ET.png"
            alt=""
            width={80}
            height={80}
